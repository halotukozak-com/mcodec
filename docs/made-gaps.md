...
> Version note: the build depends on `io.github.halotukozak:made_3:0.1.2`. (Earlier research notes referenced `0.1.1` / a local `0.0.3-SNAPSHOT`; the API surface mcodec uses is identical across them.)
